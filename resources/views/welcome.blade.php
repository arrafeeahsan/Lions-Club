...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="/">Lions Clubs International</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    
                    @if (Route::has('login'))
                        <div class="hidden fixed ms-auto mb-2 mb-lg-0 sm:block ">
        ...
        <header class="py-5 bg-image-full" style="background-image: url('img/luca-calderone-1T97FaKvno8-unsplash.jpg')">
            <div class="text-center my-5">
                <img class="img-fluid rounded-circle mb-4" src="img/Lions_Clubs_International_logo.svg" alt="Logo" />
